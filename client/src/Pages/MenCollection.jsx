...
function MenCollection() {
  const { Data: MenCollections, loading, error } = useFetch(
    "http://localhost:5000/men-collections"
  );
  ...
  return (
    <div className="container py-5">
      ...
      <div className="row g-4">
        {MenCollections?.getAllproducts?.length > 0 ? (
          MenCollections.getAllproducts.map((item) => (
