...
function AddMenCollection() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (res.ok) {
        toast.success("Men perfume added successfully!");
      } else {
  ...
  return (
    <div className="container py-5">
      <h2 className="text-center mb-4">Add Men Collection</h2>
      ...
      >
        ...
        >
          {loading ? "Saving..." : "Add Men Perfume"}
        </button>
      </form>
...
export default AddMenCollection;
